...
Critically, see [**THIS**](https://github.com/neuropsychology/psycho.R/blob/master/vignettes/bayesian.Rmd) vignette for a guide to bayesian statistics for psychology.
